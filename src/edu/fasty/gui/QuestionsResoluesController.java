 ...
 * @author FERJANI
 */
public class QuestionsResoluesController implements Initializable {
...
Forum f = sf.getForumById(Integer.parseInt(idforum));
 List<Question> questions = sq.getALLSolvedQuestions(f.getId_forum()); 
 totalSolvedID.setText("Total Solved Questions : "+questions.size());
