...
//    }
    ...
    public Transaction(int id_transaction, User id_recepteur, User id_expiditeur, int id_produit, String NomTransaction) {
        this.id_transaction = id_transaction;
        this.id_recepteur = id_recepteur;
        this.id_expiditeur = id_expiditeur;
        this.id_produit = id_produit;
     ...
     public Transaction( User id_recepteur, User id_expiditeur, int id_produit, String NomTransaction) {
        this.id_recepteur = id_recepteur;
        this.id_expiditeur = id_expiditeur;
        this.id_produit = id_produit;
        this.NomTransaction = NomTransaction;
