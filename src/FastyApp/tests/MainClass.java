...
public class MainClass {
    ...
    public static void main(String[] args) {
      ...
      /*  Transaction t1 = new Transaction(1, 1, 2, 651, "trans1");
        Transaction t2 = new Transaction(1, 1, 2, 651, "trans2");
        Transaction t3 = new Transaction(1, 1, 2, 651, "trans3");
        Transaction t4 = new Transaction(1, 1, 2, 651, "trans4");*/
...
//        System.out.println(tt.toString());
      /*  st.ajouterTransaction(t1);
        st.ajouterTransaction(t2);
        st.ajouterTransaction(t3);
        st.ajouterTransaction(t4);*/
